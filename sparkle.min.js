(function (global) {
    ...
    require.define('/zones/cuboid.js', function (module, exports, __dirname, __filename) {
        ...
        exports.cuboid = function (sx, sy, sz, inner) {
            ...
            return function (vector) {
                if (inner) {
                    vector[0] = (Math.random() - 0.5) * sx;
                    vector[1] = (Math.random() - 0.5) * sy;
                    vector[2] = (Math.random() - 0.5) * sz;
                } else {
                    var face = FACES[Math.floor(Math.random() * 6)];
                    vector[face[1]] = face[0] * this['_s' + face[1]] / 2;
                    vector[face[2]] = (Math.random() - 0.5) * this['_s' + face[2]];
                    vector[face[3]] = (Math.random() - 0.5) * this['_s' + face[3]];
                }
            };
        };
    });
